...
class Main3 extends React.Component {
                    ...
                    <>
                        <div className="ModalFondo">
                            <div className="Modal1">
                                ...
                                <div className="RangeNumber">
                                    <p>Para Valorar el curso {this.state.modal1.modal1title} necesita haberlo iniciado primero</p>
                                </div>
                                <button className="button buttonModal1" onClick={() => {
                                    this.setState({
                                        modal1: {
    ...
    putCalificacionCurso2 = async (prop, prop2, prop3) => {
                ...
                <div className="flex">
                    <div className="Filtros">
                        <div className="Filtros2">
                            <input id="filt" placeholder="Buscar" className="FiltrosC2" onChange={() => { this.filtrando(this.state.filtrar, this.state.dataCursosI) }} />
                        </div>
                    </div>
